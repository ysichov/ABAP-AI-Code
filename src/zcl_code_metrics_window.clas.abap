CLASS zcl_code_metrics_window DEFINITION
  PUBLIC
  CREATE PUBLIC.
...
CLASS ZCL_CODE_METRICS_WINDOW IMPLEMENTATION.


METHOD show.

  DATA(ls_result) = zcl_code_metrics=>calculate(
  ...
  DATA ls_u       TYPE zcl_code_metrics=>ts_unit_result.
