CLASS zcl_code_acr_stats DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS from_diff
      ...
      EXPORTING ev_ins     TYPE i
                ev_del     TYPE i
                ev_mod     TYPE i
                et_authors TYPE zif_code_acr_types=>ty_t_author_stats.
  ...
  PRIVATE SECTION.
    CLASS-METHODS add_blame
      IMPORTING iv_text     TYPE string
                ...
                it_blame    TYPE zif_code_popup_types=>ty_blame_map
      CHANGING  ct_authors  TYPE zif_code_acr_types=>ty_t_author_stats.

ENDCLASS.

CLASS zcl_code_acr_stats IMPLEMENTATION.
  ...
  METHOD from_diff.
    ...
    DATA lt_ops TYPE zif_code_popup_types=>ty_t_diff.
    lt_ops = it_diff.
        ...
        WHEN '='.
          ...
          LOOP AT lt_dels INTO DATA(lv_d).
            ...
            LOOP AT lt_ins INTO DATA(lv_i).
              ...
              CHECK <m> = abap_false.
              IF zcl_code_popup_diff=>has_common_chars( iv_a = lv_d iv_b = lv_i ) = abap_true.
                ev_mod = ev_mod + 1.
                <m> = abap_true.
                lv_paired = abap_true.
