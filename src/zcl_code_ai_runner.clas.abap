  ...
  method RUN.
    ...
    IF lt_agent_requests IS NOT INITIAL OR lv_orchestrator_read_commands IS NOT INITIAL.
      ...
      LOOP AT lt_agent_requests INTO DATA(ls_agent_request).
        ...
        IF ls_agent_request-agent = zcl_ai_agents_prompts=>c_agent_delete_obj.
          ...
          CALL FUNCTION 'POPUP_TO_CONFIRM'
            EXPORTING
              titlebar              = |Confirm deletion — cannot be undone!|
              text_question         = |Delete { lv_del_type } { lv_del_name }?|
      ...
      ELSE.
        ...
        DATA(lv_final_type) = lv_code_change_type.
        IF lv_final_type IS INITIAL.
          LOOP AT lt_agent_requests INTO DATA(ls_final_req) WHERE object_name IS NOT INITIAL.
            lv_final_type = ls_final_req-object_type.
            EXIT.
          ENDLOOP.
        ENDIF.
        TRANSLATE lv_final_type TO UPPER CASE.
